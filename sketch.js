...
function setup(){
    ...
    log1 = new Log(750,100,900,PI/2);
    log2 = new Log(750,100,900,PI/2);
    ...
    log3 =  new Log(750,100,900, PI/2);

    box5 = new Box(10,160,70,900);
    log4 = new Log(750,240,900, -PI/2);
    log5 = new Log(750,240,900, PI/2);

    bird = new Bird(10,10);

    log6 = new Log(750,240,900, PI/2);
    log7 = new Log(750,240,900,PI/2);
    log8 = new Log(750,240,900,PI/2);
    log9 = new Log(750,240,900,PI/2);
    log10 = new Log(750,240,900,PI/2);
